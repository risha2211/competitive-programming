...
- Since every duel produces exactly one winner and one loser, among n−1 duels, there cannot be more than n−1 wins in total.
...
- If the total number of 1s is greater than n-1, someone is lying.
